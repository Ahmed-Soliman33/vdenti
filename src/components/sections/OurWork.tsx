...
const OurWork = () => {
  ...
  return (
    <section id="our-work" className="bg-gray-50 py-20">
      <div className="container mx-auto px-4">
        <SectionHeading
          badge={CONTENT.ourWork.badge}
          title={CONTENT.ourWork.title}
          titleHighlight={CONTENT.ourWork.titleHighlight}
          subtitle={CONTENT.ourWork.subtitle}
        />
        ...
        {!showAll && workItems.length > 3 && (
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-primary font-inter text-white hover:bg-primary/90"
            >
              عرض المزيد
            </Button>
          </motion.div>
